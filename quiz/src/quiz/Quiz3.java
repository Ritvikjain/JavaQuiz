...
public class Quiz3 extends JFrame {
	...
	public Quiz3(String reg) 
	{
		...
		String query="select* from questions3";
		try
		{
		...
		btnNextQues.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{	
					String query="update student set quiz3=? where regno=?";
					int i=0;
					try
					{
						PreparedStatement ps=con.prepareStatement(query);
					...
					if(i==1)
					{
						JOptionPane.showMessageDialog(Quiz3.this, "Quiz Completed Your Score:"+ marks+" out of 10");
						Quiz3.this.setVisible(false);
					}
				}
			}
		});
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				if(rdbtnOptionA.isSelected())
				{
					...
					String ques=textArea.getText();
					String query="select * from questions3 where question=?";
					try
					{
						PreparedStatement ps=con.prepareStatement(query);
						ps.setString(1, ques);
