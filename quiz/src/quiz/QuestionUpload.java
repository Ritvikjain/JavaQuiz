...
public class QuestionUpload extends JFrame {
	...
	public QuestionUpload() 
	{
		...
		JLabel lblTypeOfQuiz = new JLabel("Type Of Quiz");
		...
		btnUploadQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(i==1)
				{
					JOptionPane.showMessageDialog(QuestionUpload.this,"Data Inserted");
				...
				if(i==0)
				{
					JOptionPane.showMessageDialog(QuestionUpload.this,"Registration Failed!!");
				} 
				}
					...
					String ans=textField_4.getText();
					Connection con=DBInfo.con;
					String query="insert into questions2 values(?,?,?,?,?,?)";
					int i=0;
					try
					{
						PreparedStatement ps=con.prepareStatement(query);
					...
					String ans=textField_4.getText();
					Connection con=DBInfo.con;
					String query="insert into questions3 values(?,?,?,?,?,?)";
					int i=0;
					try
					{
						PreparedStatement ps=con.prepareStatement(query);
					...
					JOptionPane.showMessageDialog(QuestionUpload.this, "Fill All Entries Properly");
			}
		});
