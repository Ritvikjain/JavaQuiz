...
public class Quiz extends JFrame {
	...
	public Quiz(String reg) 
	{
		...
		lblNewLabel.setIcon(new ImageIcon(new ImageIcon("quiz.jpg").getImage().getScaledInstance(200, 150, Image.SCALE_DEFAULT)));
		...
		btnNextQues.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{	
					String query="update student set quiz1=? where regno=?";
					int i=0;
					try
					{
						PreparedStatement ps=con.prepareStatement(query);
					...
					if(i==1)
					{
						JOptionPane.showMessageDialog(Quiz.this, "Quiz Completed Your Score:"+ marks+"out of 10");
		...
		JButton btnSubmit = new JButton("Save Ans.");
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_contentPane.createSequentialGroup()
											.addGap(40)
											.addComponent(btnSubmit, GroupLayout.PREFERRED_SIZE, 102, GroupLayout.PREFERRED_SIZE)))
									.addGap(42)
